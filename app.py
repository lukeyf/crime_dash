...
def generate_control_card():
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Br(),
            html.Hr(),
            html.P("Select Analyzing Factor"),
            dcc.Dropdown(
                id="factor-select",
        ...
        html.Div(
            ...
            children=[
                html.Div(
                    id="us-map-section",
                    children=[
                        html.B("Interactive Map of Crime Rate in Communities of United States"),
                        html.Hr(),
                ...
                html.Div(
                    id="scatter-section",
                    children=[
                        html.B("Visualization of Correlation Analysis with Given Factor"),
                        html.Hr(),
...
def update_scatter(state, column):
    filtered_df = df
    if state != 'All':
        filtered_df = df[
            (df["state"] == state)
    ...
    fig = px.scatter(filtered_df, 
        ...
        title="Correlation of Crime Rate versus "+column_list[column],
        hover_data=['area'],
        labels={
